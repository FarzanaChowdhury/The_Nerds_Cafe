<?php
	...
	$Translation['sign in here']="Welcome back to Nerd's Cafe!.";
	...
	$Translation['registered? sign in']="Already registered? <a href=index.php?signIn=1>Welcome back to Nerds Cafe</a>.";
