...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2022 at 11:40 AM
...
(1, '2022-11-12', '08:00:00', 'COM 205', 'NS4', 1, 1, '2', '10:00:00'),
(2, '2018-12-10', '11:00:00', 'COM315', 'ED10', 2, 2, '3', '13:00:00'),
(3, '2022-11-12', '01:00:00', '2', 'bangladesh', 2, 2, '1', '03:05:00');
...
(18, 'exam_time_table', '3', 'admin', 1668233927, 1668233930, 2),
(19, 'notices', '3', 'admin', 1668335706, 1668335706, 2);
...
('admin', '7488e331b8b64e5794da3fa4eb10ad5d', 'sidratultanzila@gmail.com', '2018-12-04', 2, 0, 1, NULL, NULL, NULL, NULL, 'Admin member created automatically on 2018-12-04\nRecord updated automatically on 2018-12-04', NULL, NULL),
...
('tasmi', 'b2bab4fd92677e16b54017fea2e1ad7c', 'Sidratultanzila@gmail.com', '2022-11-12', 3, 0, 1, '', '', '', '', 'member signed up through the registration form.', NULL, NULL);
...
(1, 'IUT Admission Circular 2022\r\nAdmission Application has been Started from 21 March 2022 and it will be continue till the 9 April 2022. Bangladeshi students and international students can apply for admission from the same website.', 1, 1, '2', '2018-12-04'),
(2, 'DU admission circular 2022 has been announced on DU admission website admission.eis.du.ac.bd.  Before submitting admission applications candidates should know about the basic requirements for each unit, deadlines and much more information.', 1, 1, '2', '2018-12-04'),
(3, 'Invitation for expressing wish for admission through IUT website ; 6 July, 2022, Notification for Medical Checkup list for the academic', 1, 1, '1', '2022-11-13');
...
CREATE TABLE IF NOT EXISTS `personal_time_table` (
`id` int(10) unsigned NOT NULL,
  `day` varchar(40) NOT NULL,
  `time_start` time NOT NULL,
...
ALTER TABLE `class_time_table`
 ADD PRIMARY KEY (`id`), ADD KEY `school` (`school`), ADD KEY `department` (`department`);
...
ALTER TABLE `student_details`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `reg_no_unique` (`reg_no`), ADD KEY `school` (`school`), ADD KEY `department` (`department`);
