     ...
     <div class="yellow_darkbg">
      ...
      <div class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <form id="request" class="main_form" action="function.php" method="post">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="contactus" placeholder="Name" type="type" name="cntName" required> 
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Email" type="type" name="cntEmail"> 
                        </div>
                        <div class="col-md-12">
                           <input class="contactus1" placeholder="Type Message Here.." type="type" name="cntMSG">
                        </div>
                        <div class="col-md-12">
                           <button class="send_btn" name="cntBTN">Send</button>
                        </div>
                     </div>
                  </form>
               </div>
